...
%{
地址::Matlab\spectrometer\scan_spectrometer_10727.m
+[保存M函数](,扫描代码)
%}


function [a,Fn,e,theta,energy,E_p] = scan_spectrometer_10727(dr_e,dr_m,dr_f1,dr_f2,dr_p,pt0,Dtheta)
...
shadow0=[408.0, 660.0, 854.0, 1047.0, 1173.0, 1329.0, 1418.0, 1546.0, 1624.0];
Cell0=[-26.4,0,0];
IP=[247.6,0,0];
size_m=[5,5];
pos_m=[2.5,0,-3];
