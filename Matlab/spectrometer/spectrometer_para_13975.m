...
%{
地址::Matlab\spectrometer\spectrometer_para_13975.m
+[保存M函数](,spectrometer_para_13975)
%}


function [Cell,Ma,B0,Fx,Fy,shX,shY,pos_p]=spectrometer_para_13975(dr_e,dr_m,dr_f1,dr_f2,dr_p,pt0,Dtheta)
