%{
地址::Matlab\spectrometer\scan_spectrometer_shadows.m
+[保存文本](,scan_spectrometer_shadows)
...
function [a,Fn,e,theta,energy]=scan_spectrometer_shadows(shadow0,dr_e,dr_m,dr_f1,dr_f2,dr_p,pt0,Dtheta)
