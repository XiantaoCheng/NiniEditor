...
%{
地址::Matlab\spectrometer\scan_spectrometer_10724.m
+[保存M函数](,扫描代码)
%}


function [a,Fn,e,theta,energy,E_p] = scan_spectrometer_10724(dr_e,dr_m,dr_f1,dr_f2,dr_p,pt0,Dtheta)
...
shadow0=[410.0, 661.0, 857.0, 1049.0, 1176.0, 1332.0, 1420.0, 1548.0, 1626.0];
Cell0=[-26.4,0,0];
IP=[247.6,0,0];
size_m=[5,5];
pos_m=[2.5,0,-3];
